...
# Make sure the dependencies are met
RUN eval ${APT_INSTALL_PRE} tigervnc-standalone-server tigervnc-common xfce4-session xfce4-goodies eterm xterm git net-tools python2 python-numpy ca-certificates scrot sudo ${APT_INSTALL_POST}
